...
def train_supervised(epoch):
    ...
    training_sup_accuracy.append(accuracy)
...
pickle.dump( training_sup_accuracy, open( 'training_accuracy'+args.save_as+'.p', "wb" ) )
pickle.dump( validation_accuracy, open( 'validation_accuracy'+args.save_as+'.p', "wb" ) )

modelname = 'model/'+args.save_as + ".p"
